...
<jsp:useBean id="userForm" class="User.UserForm" scope="page"/>
...
<ul>
    ...
    <li>性　　别：${userForm.sex}</li>
      ...
      <li><input name="Button" type="button" class="btn_grey" value="返回" onClick="window.location.href='exp04_5.jsp'"></li>
</ul>
</body>
</html>